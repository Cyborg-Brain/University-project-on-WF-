...
namespace Testing.Domain.Entities.Infrastructure.Helpers
{
    ...
    public class DataGridViewListBoxCell : DataGridViewCell
    {
        public DataGridViewListBoxCell()
            : base()
        {
            ...
            initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            ListBoxEditingControl ctl =
                DataGridView.EditingControl as ListBoxEditingControl;
            InitializeListBox(ctl, (ICollection)this.FormattedValue);
        }
        private void InitializeListBox(ListBox ctrl, ICollection value)
        {
            ctrl.Items.Clear();
        ...
        private ListBox internalControl;
